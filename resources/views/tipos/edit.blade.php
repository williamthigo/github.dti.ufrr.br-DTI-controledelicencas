            ...
            {{Form::token()}}
                <div class="form-group row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <label>Tipo</label>
                        <input class="form-control" id="nometipo" name="nometipo" type="text" placeholder="Nome do Software" value="{{$result->nome}}" required>
                    </div>
                </div>
                <input type="hidden" id="idtipo" name="idtipo" value="{{$result->id}}">
